...
export default function MyBookingsScreen() {
  ...
  const renderBookingItem = ({ item }) => {
    ...
    const imageUrl =
      item?.experience?.images?.[0] || "https://via.placeholder.com/150";
        ...
        <View style={styles.cardMain}>
          ...
          <View style={styles.infoContainer}>
            ...
            <View style={styles.detailRow}>
              ...
              <Text style={styles.detailText}>{safeFormatDate(item?.bookingDate)}</Text>
            </View>

            <View style={styles.detailRow}>
              <Ionicons name="time-outline" size={14} color="#666" />
              <Text style={styles.detailText}>{getDisplayTime(item)}</Text>
            </View>
          </View>
        </View>
