...
import { View, Text, StyleSheet, FlatList, TextInput, TouchableOpacity, Image, ActivityIndicator, ScrollView, Dimensions } from 'react-native';
...
/**
 * CultureScreen: Displays a compact list of cultural experiences.
 * Optimized for quick scanning with host details and pricing.
 */
export default function CultureScreen() {
    ...
    useEffect(() => { fetchExperiences(); }, [searchQuery, selectedCategory]);

    /**
     * Fetches cultural experiences based on search and category filters
     */
    ...
    /**
     * Renders a compact card for each experience with Host info
     */
    const renderExperienceCard = ({ item }) => (
        ...
        >
            {/* Left Section: Image and Category Overlay */}
            ...
            {/* Right Section: Content and Metadata */}
            <View style={styles.textContainer}>
                <View>
                    ...
                    {/* NEW: Host Name Section - Establishes trust and authenticity */}
                ...
                {/* Bottom Section: Pricing and Navigation CTA */}
            ...
            <LinearGradient colors={['#2E7D32', '#1B5E20']} style={styles.header}>
                <View style={styles.headerTopRow}>
                    <View>
                        ...
                        <Text style={styles.headerSubtitle}>Discover traditions 🇱🇰</Text>
                    </View>
...
const styles = StyleSheet.create({
    ...
    bookIcon: { backgroundColor: 'rgba(255,255,255,0.2)', padding: 8, borderRadius: 10 },
    ...
    // Ultra Compact Card Design (Master View)
    ultraCompactCard: { 
        flexDirection: 'row', 
        backgroundColor: '#FFF', 
        borderRadius: 15, 
        marginBottom: 12, 
        height: 115, // Adjusted to fit Host info
        elevation: 3, 
        shadowColor: '#000', 
        shadowOpacity: 0.04, 
        shadowRadius: 5,
    ...
    titleMain: { fontSize: 15, fontWeight: '700', color: '#222', flex: 1, marginRight: 4, lineHeight: 18 },
    
    // Host Identification Styles
    hostRow: { flexDirection: 'row', alignItems: 'center', marginTop: 4, gap: 4 },
    hostNameText: { fontSize: 12, color: '#666', fontWeight: '500', fontStyle: 'italic' },

    // Rating Metadata Styles
    ...
    circleArrow: { backgroundColor: '#2E7D32', width: 26, height: 26, borderRadius: 13, justifyContent: 'center', alignItems: 'center' }
});